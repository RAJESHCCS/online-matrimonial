		...
		<div class="container"> 
            ...
            <div class="col-sm-6">
            	<div class="bg_left">
            		...
            		<p><div class="team-details">A collection of blogs on relationships, marriage, meetups and love. Following these tips and advise can help you in your relationship journey. Makes you better prepared to have great relationships. <span style="display:block;width:100%;text-align:right"><a href="https://blog.shadi.com/how-to-be-approachable/"><strong>read more</strong></a></span></div></p>
            ...
            <div class="col-sm-6">
            	<div class="bg_left">
            		...
            		<p><div class="team-details">Connect with someone special in your city and nearby. Our members are educated and looking for long term relationships. If you are looking for meaningful connections we can help in life partner search. <span style="display:block;width:100%;text-align:right"><a href="https://www.shadi.com/top-ranking-citiies-shadi"><strong>read more</strong></a></span></div></p>
            	   <ul class="team-socials">
                    <li><a href="#"><span class="icon-social "><i class="fa fa-facebook"></i></span></a></li>
                    <li><a href="#"><span class="icon-social "><i class="fa fa-twitter"></i></span></a></li>
                    <li><a href="#"><span class="icon-social"><i class="fa fa-google-plus"></i></span></a></li>
